...
use crate::{constants::API_MAPS_TABLE_NAMES, data_types::{TermIdDetailsMap, UniquenameGeneMap, UniquenameReferenceMap, IdGenotypeMap}};
...
pub fn store_maps_into_database(conn: &mut Connection, terms: &TermIdDetailsMap,
                                ...
                                genotypes: &IdGenotypeMap) -> anyhow::Result<()> {
    let tx = conn.transaction()?;
